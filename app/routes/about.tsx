      ...
      <main className="mt-29">
        ...
        <section className="flex flex-col lg:flex-row items-center justify-center lg:justify-between py-20 px-8 lg:px-16 max-w-7xl mx-auto gap-10 lg:gap-0 overflow-hidden">
          ...
          <div className="relative mt-10 lg:mt-0 w-full lg:w-auto" data-aos="fade-left" data-aos-duration="300">
              <img src="/images/home/s3-image4.jpg" alt="image 1" className="w-full lg:max-w-lg h-72 lg:h-96 rounded-xl object-cover md:object-[-60px] lg:object-center shadow-xl" />
              <img src="/images/home/s3-image3.jpg" alt="image 2" className="w-36 lg:w-48 h-36 lg:h-48 rounded-full border-4 border-white shadow-lg absolute bottom-[-50px] lg:bottom-[-70px] right-1/4 lg:right-[-20px] object-cover" />
          </div>
        </section>
        ...
        <section className="flex flex-col items-center justify-between py-20 px-16 bg-secondary">
          ...
          <div className="flex flex-row flex-wrap justify-around lg:justify-between items-center gap-5 mb-7 w-full max-w-250" data-aos="zoom-in" data-aos-duration="300">
            ...
            <div className="w-70 h-96 group relative overflow-hidden rounded-lg shadow-lg">
              ...
              <div className="absolute inset-0 flex items-center justify-center p-6 opacity-0 pointer-events-none transition-opacity duration-300 group-hover:opacity-100 group-hover:pointer-events-auto">
                <p className="text-white text-lg leading-relaxed text-center">
                  Will brings over 20 years of hospitality leadership, focused on
                  guest experience, operational excellence, and strategic growth.
                </p>
              </div>
              <div className="absolute left-0 right-0 bottom-3 text-center text-white">
                <h3 className="mb-1.5 text-white font-medium text-xl">Will Peter</h3>
            ...
            <div className="w-70 h-96 group relative overflow-hidden rounded-lg shadow-lg">
              ...
              <div className="absolute inset-0 flex items-center justify-center p-6 opacity-0 pointer-events-none transition-opacity duration-300 group-hover:opacity-100 group-hover:pointer-events-auto">
                <p className="text-white text-lg leading-relaxed text-center">
                  Jane leads our operations and finance teams with a keen eye
                  for efficiency and people development, helping teams exceed
                  their goals.
                </p>
              </div>
              <div className="absolute left-0 right-0 bottom-3 text-center text-white">
                <h3 className="mb-1.5 text-white font-medium text-xl">Jane Williams</h3>
            ...
            <div className="w-70 h-96 group relative overflow-hidden rounded-lg shadow-lg">
              ...
              <div className="absolute left-0 right-0 bottom-3 text-center text-white">
                <h3 className="mb-1.5 text-white font-medium text-xl">Jeffrey Neddery</h3>
        ...
        {/* Section 5 History */}
        <section className="w-full grid place-items-center py-16 px-5 lg:px-16 pb-24 bg-secondary" data-aos="fade-down" data-aos-duration="300">
