    ...
    <>
      ...
      <main>
          ...
          <div className="bg-black/50 h-full">
            <div className="flex flex-col items-center justify-center h-full w-full text-white text-center px-5">
              <h3 className="mb-4 font-black flex items-center gap-2 text-sm lg:text-base tracking-widest text-accent uppercase">
                Welcome to <span className="flex items-center text-white"><Star className="text-accent w-4 h-4 mr-1" fill="currentColor" /> 5 Star</span> Hotel
              </h3>
              <h1 className="text-4xl lg:text-7xl font-serif font-bold text-white mb-8 leading-tight">A Best Place To Stay</h1>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-5 lg:px-15 bg-secondary flex flex-col items-center">
          <div className="max-w-3xl text-center mb-16" data-aos="fade-down" data-aos-duration="500">
            <h1 className="text-4xl lg:text-5xl font-serif font-bold text-primary-2 mb-6">Rooms & Suites</h1>
            <p className="text-text-light leading-relaxed text-lg">
              Escape to tranquility in our elegantly designed rooms and suites,
              where comfort meets luxury. Tucked away from the world's hustle, our
              accommodations offer a peaceful retreat with stunning views and modern amenities.
            </p>
          </div>
          
          <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="zoom-in-up" data-aos-duration="500">
            {/* Room Card 1 */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group">
              <div className="overflow-hidden h-64">
                <img src="/images/home/s3-image1.jpg" alt="Single Room" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
              </div>
              <div className="p-6 text-center">
                <h3 className="font-serif text-2xl font-bold text-text-dark mb-2">Single Room</h3>
                <p className="text-accent font-semibold text-lg">$90 <span className="text-sm font-normal text-text-light">/ per night</span></p>
              </div>
            </div>
            {/* Room Card 2 */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group">
              <div className="overflow-hidden h-64">
                <img src="/images/home/s3-image2.jpg" alt="Family Room" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
              </div>
              <div className="p-6 text-center">
                <h3 className="font-serif text-2xl font-bold text-text-dark mb-2">Family Room</h3>
                <p className="text-accent font-semibold text-lg">$120 <span className="text-sm font-normal text-text-light">/ per night</span></p>
              </div>
            </div>
            {/* Room Card 3 */}
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden group">
              <div className="overflow-hidden h-64">
                <img src="/images/home/s3-image3.jpg" alt="Presidential Room" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
              </div>
              <div className="p-6 text-center">
                <h3 className="font-serif text-2xl font-bold text-text-dark mb-2">Presidential Suite</h3>
                <p className="text-accent font-semibold text-lg">$250 <span className="text-sm font-normal text-text-light">/ per night</span></p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-5 lg:px-15 bg-white flex flex-col items-center">
          <div className="max-w-3xl text-center mb-16" data-aos="fade-up" data-aos-duration="500">
            <h1 className="text-4xl lg:text-5xl font-serif font-bold text-primary-2 mb-6">Photos Gallery</h1>
            <p className="text-text-light leading-relaxed text-lg">
              ...
              interiors, each photo tells the story of a perfect getaway.
            </p>
          </div>
        ...
        <section className="py-20 px-5 lg:px-15 bg-primary-2 text-white">
          <div className="max-w-7xl mx-auto flex flex-col items-center">
            <div className="max-w-3xl text-center mb-16" data-aos="zoom-in" data-aos-duration="500">
              <p className="text-accent uppercase tracking-widest text-sm font-semibold mb-4">Culinary Experience</p>
              <h1 className="text-4xl lg:text-5xl font-serif font-bold mb-6">Our Restaurant Menu</h1>
              <p className="text-gray-300 leading-relaxed text-lg">
                Indulge in a culinary journey like no other. Our menu offers a variety of
                mouthwatering dishes crafted with the finest ingredients.
              </p>
            </div>
            ...
            <div className="w-full max-w-lg mx-auto mb-16 border-b border-white/20">
              <div className="flex items-center justify-center gap-8 lg:gap-16 pb-4">
                <button onClick={() => setActiveMenu('mains')} className={`text-base lg:text-lg font-bold tracking-wider transition-colors ${activeMenu === 'mains' ? 'text-accent' : 'text-gray-400 hover:text-white'}`}>
                  MAINS
                </button>
                <button onClick={() => setActiveMenu('desserts')} className={`text-base lg:text-lg font-bold tracking-wider transition-colors ${activeMenu === 'desserts' ? 'text-accent' : 'text-gray-400 hover:text-white'}`}>
                  DESSERTS
                </button>
                <button onClick={() => setActiveMenu('drinks')} className={`text-base lg:text-lg font-bold tracking-wider transition-colors ${activeMenu === 'drinks' ? 'text-accent' : 'text-gray-400 hover:text-white'}`}>
                  DRINKS
                </button>
              </div>
            </div>
        ...
        <section className="bg-[url('/images/hero.jpg')] bg-cover bg-no-repeat bg-center bg-fixed py-24 relative">
          ...
          <div className="max-w-7xl mx-auto px-5 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 text-center lg:text-left text-white">
            <h2 className="text-4xl lg:text-5xl font-serif font-bold" data-aos="fade-right" data-aos-duration="500">
              A Best Place To Stay. Reserve Now!
            </h2>
            <Link to="/reservation" data-aos="fade-left" data-aos-duration="500">
