...
export default function Login() {
  return (
    <>
      ...
      <main style={{ fontFamily: "var(--font-sans)" }} className="min-h-screen flex items-center justify-center pt-32 pb-10 bg-secondary px-5 font-sans">
        <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl">
          <h1 className="text-3xl font-sans font-bold text-primary-1 mb-2" style={{ fontFamily: "var(--font-sans)" }}>Log In</h1>
          <p className="mb-8 text-text-light font-sans">Welcome back! Enter your details to access your account.</p>
          ...
          <p className="mt-6 text-center text-sm text-text-light font-sans">
            ...
            <Link to="/signup" className="font-semibold text-primary-1 hover:text-primary-2">
              Sign Up
            </Link>
          </p>
